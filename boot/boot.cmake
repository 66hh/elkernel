...
set(_BOOT_SRC "")
set(_SEARCH_FILES "")
  file(GLOB_RECURSE _SEARCH_FILES ${ELKERNEL_BOOT_DIR}/legacy/*.s)
...
set(CUSTOM_IMM_PATH ${ELKERNEL_BUILD_DIR}/CMakeFiles)
  foreach(_SRC IN LISTS _BOOT_SRC)
    ...
    add_custom_target(${_FILE} ALL
      ...
      COMMAND echo "as --32 ${_SRC} -o ${CUSTOM_IMM_PATH}/${_FILE}.dir/${_FILE}.o"
...
add_custom_target(${PROJECT_NAME} ALL
  ...
  COMMAND ld -m elf_i386 -T ${ELKERNEL_BOOT_DIR}/legacy/link.ld ${_LINK_CMD} -o ${PROJECT_NAME}.elf
